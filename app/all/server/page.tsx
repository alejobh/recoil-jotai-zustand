...
const State = dynamic(() => import('../../state/server/page'), {
  loading: () => <Loading text="state" />,
});

const Zustand = dynamic(() => import('../../zustand/server/page'), {
  loading: () => <Loading text="Zustand" />,
});

const Recoil = dynamic(() => import('../../recoil/server/page'), {
  loading: () => <Loading text="Recoil" />,
});

const Jotai = dynamic(() => import('../../jotai/server/page'), {
...
const AllServer = () => (
  <PageContainer>
    <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <div className="flex flex-col">
        <h2 className="text-center text-3xl font-semibold">Zustand</h2>
        <Zustand />
      </div>
      <div className="flex flex-col">
        <h2 className="text-center text-3xl font-semibold">Recoil</h2>
        <Recoil />
      </div>
      <div className="flex flex-col">
